          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                orderStatus(color: Colors.blue, icon: Icons.thumb_up, title: "Confirmed", showDone: data['order_confirm']),
                orderStatus(color: Colors.green, icon: Icons.delivery_dining, title: "On Delivery", showDone: data['order_on_delivery']),
