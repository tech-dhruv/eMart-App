        ...
        bottomNavigationBar: SizedBox(
          ...
          child: controller.placingOrder.value
              ...
              : ourButton(
                  ...
                  title: "Place my order is",
                ),
        ),
        appBar: AppBar(
          title: "Choose Paymnet Method".text.fontFamily(semibold).color(darkFontGrey).make(),
        ),
        body: Padding(
                  ...
                  child: Container(
                    ...
                    child: Stack(alignment: Alignment.topRight, children: [
                      ...
                      controller.paymentIndex.value == index
                          ...
                          : Container(),
                      Positioned(bottom: 10, right: 10, child: paymentMethods[index].text.white.fontFamily(semibold).size(16).make()),
                    ]),
                  ),
                );
              }),
